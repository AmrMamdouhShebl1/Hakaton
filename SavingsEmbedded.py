...
# List of Word documents containing savings plans info
docx_files = [
    "docs/english/saving.docx",
...
# Print summary
print(f"\nFound {len(product_docs)} savings products in documents")
...
if not product_docs:
    ...
    db = Chroma.from_documents(
        ...
        persist_directory="emb_savings_plans"  # Directory for savings plans
    )

    print(f"Successfully created savings plans vector store in 'emb_savings_plans'")
    print(f"Embedded {len(product_docs)} savings products in total.")

print("\nSavings plans embedding process complete!")