...
# List of English Word documents to embed
docx_files = [
    "docs/english/properties.docx",
    # Add more English property documents as needed
]
...
# Print summary
print(f"\nFound {len(property_docs)} properties in English documents")
...
if not property_docs:
    ...
    db = Chroma.from_documents(
        ...
        persist_directory="emb_default_english"  # Specify directory to persist embeddings
    )

    print(f"Successfully created English vector store in 'emb_default_english'")
    print(f"Embedded {len(property_docs)} English properties in total.")

print("\nEnglish embedding process complete!")